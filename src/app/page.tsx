  ...
  return (
    <Layout>
      ...
      <div style={{ padding: '2rem', fontFamily: 'Poppins, sans-serif' }}>
        <p style={{ fontSize: '1.2rem', marginBottom: '1rem' }}>Discover our eco-friendly beachfront bungalows nestled on the pristine shores of Salad Beach, Koh Phangan.</p>
        <div style={{ backgroundColor: '#f8f9fa', padding: '1rem', borderRadius: '8px', marginBottom: '1rem' }}>
          <h3 style={{ color: '#ed6664', marginBottom: '0.5rem' }}>Why Choose Coconut Beach?</h3>
        ...
        <div style={{ backgroundColor: '#ed6664', color: 'white', padding: 'var(--spacing-md)', borderRadius: '4px', textAlign: 'center', marginTop: '2rem' }}>
